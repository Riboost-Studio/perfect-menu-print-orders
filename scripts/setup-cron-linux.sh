...
# Setup cron job for Perfect Menu Print Orders on Linux
# Usage: ./setup-cron-linux.sh

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
BINARY_NAME="perfect-menu_print_orders-amd64-linux"
...
echo "Perfect Menu Print Orders - Cron Setup for Linux"
echo "=================================================="
echo ""
