...
# Setup cron job for Perfect Menu Print Orders on macOS
# Usage: ./setup-cron-macos.sh

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
BINARY_NAME="perfect-menu_print_orders-amd64-macos"
...
echo "Perfect Menu Print Orders - Cron Setup for macOS"
echo "================================================="
echo ""
